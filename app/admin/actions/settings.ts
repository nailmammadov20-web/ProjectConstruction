...
export async function updateSiteSettings(_prevState: { error?: string; success?: boolean }, formData: FormData) {
  try {
    ...
    const data = {
      ...
      qualityTeaserTitle: readLocalized(formData, "qualityTeaserTitle"),
      qualityTeaserBody: readLocalized(formData, "qualityTeaserBody"),
      qualityTeaserImage: readImage(formData, "qualityTeaserImage"),
