...
function toSettings(row: PrismaSiteSettings): SiteSettings {
  return {
    ...
    aboutTeaserTitle: row.aboutTeaserTitle as unknown as LocalizedText,
    aboutHighlights: row.aboutHighlights as unknown as LocalizedText[],
    aboutTeaserImage1: row.aboutTeaserImage1 as unknown as ImageAsset,
    aboutTeaserImage2: row.aboutTeaserImage2 as unknown as ImageAsset,
    ...
    qualityTeaserTitle: row.qualityTeaserTitle as unknown as LocalizedText,
    qualityTeaserBody: row.qualityTeaserBody as unknown as LocalizedText,
    qualityTeaserImage: row.qualityTeaserImage as unknown as ImageAsset,
