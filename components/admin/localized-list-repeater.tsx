...
export function LocalizedListRepeater({
  name,
  label,
  defaultValue,
  hint,
  ...
  emptyLabel = "Hələ mətn əlavə edilməyib.",
}: {
  name: string;
  label: string;
  ...
  const [items, setItems] = React.useState<LocalizedText[]>(defaultValue.length ? defaultValue : []);
  ...
  function updateItem(index: number, value: LocalizedText) {
